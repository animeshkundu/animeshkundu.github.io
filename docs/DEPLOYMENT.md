...
1. **Production Deployment**: Deploys from `master`/`main` branch to `https://animesh.kundu.in/`
2. **Preview Deployment**: Deploys feature branches to `https://animesh.kundu.in/test-{branch-name}/`
...
```
https://animesh.kundu.in/projects
https://animesh.kundu.in/project/youtube-audio
```

**Preview (subdirectory `/test-{branch}/`)**: Uses `HashRouter` to work around GitHub Pages limitations
```
https://animesh.kundu.in/test-branch/#/projects
https://animesh.kundu.in/test-branch/#/project/youtube-audio
```
...
3. Visit `https://animesh.kundu.in/test-{branch-name}/`
