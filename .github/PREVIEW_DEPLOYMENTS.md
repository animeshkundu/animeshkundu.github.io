...
3. **Deploy**: The built site is deployed to `https://animesh.kundu.in/test-{branch-name}/`
...
**Examples:**
- Branch `feature/dark-mode` → `https://animesh.kundu.in/test-feature-dark-mode/`
- Branch `fix-bug-123` → `https://animesh.kundu.in/test-fix-bug-123/`
- Branch `copilot/improve-dark-mode-design` → `https://animesh.kundu.in/test-copilot-improve-dark-mode-design/`
...
The `main`/`master` branch deploys to the root: `https://animesh.kundu.in/`
...
3. **Visit your preview**
   ```
   https://animesh.kundu.in/test-your-branch-name/
   ```
